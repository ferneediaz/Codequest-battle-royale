...
const Header: React.FC = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Still try to navigate and reload on error
      navigate('/');
      window.location.reload();
    }
  };
  ...
  return (
    <header className="w-full bg-gray-900/80 backdrop-blur-sm border-b border-gray-800 py-3 px-4 relative z-50">
          ...
          {authLoading ? (
            ...
            <div className="flex items-center">
              ...
              <Button 
                variant="outline" 
                size="sm"
                className="border-gray-700 text-slate-300 hover:bg-gray-800 relative z-50"
